...
export default function Hitter() {
  ...
  const animateStyle = `w-1/2 bg-[#D4D4D4] rounded-2xl flex flex-col items-center py-6 px-3 xs:px-4 sm:px-5 before:text-sm sm:before:text-base before:content-['선택타자기록'] before:font-[Pretendard-Bold] before:border-[1px] before:py-3 before:px-8 before:rounded-xl before:text-[#242424] before:bg-white before:absolute before:top-[-2rem] before:shadow-md ${
  ...
  return (
    <section className={animateStyle}>
      <section className="flex gap-4 items-center">
        ...
        />
        <strong className="text-base sm:text-2xl">{player!.name}</strong>
      </section>
