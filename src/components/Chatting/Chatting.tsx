...
export default function Chatting() {
  ...
  return (
    <section className="bg-white w-1/3 flex flex-col rounded-2xl  py-5 px-8">
      ...
      <ul className="h-4/5 text-white flex flex-col gap-2 overflow-y-auto">
        <Message
          content={
      ...
      <section className="h-[15%] rounded-xl py-2.5 px-5 bg-[#eeeeee] flex flex-col justify-between">
