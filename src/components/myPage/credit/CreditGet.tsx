...
export default function CreditGet (){
    ...
    <>
      <div className="flex items-center w-full justify-center">
        <table className="font-[100]">
          ...
          <th className="w-[200px] text-center">획득일자</th>
            <th className="w-[200px] text-center">상세내용</th>
            <th className="w-[200px] text-center">유효기간</th>
            <th className="w-[200px] text-center">포인트</th>
          </tr>
